...
public class SBI implements bankEligblity {
	...
	public SBI(String branch_Name, String account_Holder_Name, int account_Number, int iSFC_Code, int costumer_Rating) {
		super();
		Branch_Name = branch_Name;
		Account_Holder_Name = account_Holder_Name;
		Account_Number = account_Number;
